...
parser.add_argument('-e', '--epochs',
                    ...
                    default=45)  # we used 300 on our dataset
...
if __name__ == '__main__':
    wandb.init(config=args,project='VIVIT')
    ...
    # criterion = My_loss()
    # criterion = nn.HuberLoss()  #适合回归的loss
    ...
    # Ready to start
    fn_best_model = path.join('../results/', 'vivit_rol_{}_{}_{}_model.pth'.format(network_type, now_str, init_mode))
