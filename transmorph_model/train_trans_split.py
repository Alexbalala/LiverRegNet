...
# from utils.loss_sre import My_loss
...
batch_size = 3# we used 8 or 16 in our experiments
...
if __name__ == '__main__':
    ...
    # optimizer = optim.AdamW(model_ft.parameters(), lr=lr, betas=(0.9, 0.999), weight_decay=0.1)  # 还不错 val loss 可以达到0.46
    #还不错 val loss 可以达到0.46
    ...
    # Ready to start
    fn_best_model = path.join('../results/', 'transmorph_all_{}_{}_{}_model.pth'.format(network_type, now_str, init_mode))
